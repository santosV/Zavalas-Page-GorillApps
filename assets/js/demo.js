    ...
    initMaterialWizard: function() {
        ...
        $('.wizard-card').bootstrapWizard({
            ...
            onNext: function(tab, navigation, index) {
                ...
                switch(index){
                    case 2:
                        $('#tipoNotaChecks [type="checkbox"]').each(function(){
                        ...
                        break;
                    case 3:
                        $('#categoriaTraje [type="checkbox"]').each(function(){
                            if($(this).attr('checked')){
                               $valid = true;
                             }
                        });
        ...
        $('[data-toggle="wizard-checkbox"]').click(function() {
            ...
            //LIMPIA LOS CHEKS BOX AL SELECCIONAR OTRO :V
             $('#'+$(this).parent().parent().attr('id')+' input[type=checkbox]').removeAttr('checked');
             var opcion = $(this).find('[type="checkbox"]').attr('id');
             $('#'+ $(this).parent().parent().attr('id') +' .choice').each(function(){
